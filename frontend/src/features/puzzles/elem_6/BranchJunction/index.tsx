                ...
                <div className="relative mt-6 flex-1 min-h-[420px]">
                    <div className="grid gap-4 md:hidden">
                        <ChoiceButton
                            ...
                            lockedInLabel={t('common.lockedIn')}
    ...
    return (
        ...
        >
            <div className="flex items-center justify-between gap-3">
                ...
                {selected && <span className="rounded-full border border-emerald-400/40 bg-emerald-500/10 px-3 py-1 text-[10px] font-mono uppercase tracking-[0.2em] text-emerald-200">{lockedInLabel}</span>}
            </div>
