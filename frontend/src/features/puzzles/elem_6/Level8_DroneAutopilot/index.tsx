                                            ...
                                            >
                                                {cell === 2 && (
                                                    <span className={`text-[11px] ${currentFrame.repairedPanels.includes(`${rowIndex},${colIndex}`) ? 'text-emerald-200' : 'text-amber-200'}`}>
                                                        {currentFrame.repairedPanels.includes(`${rowIndex},${colIndex}`) ? t('level8.gridLabels.fixed') : t('level8.gridLabels.repair')}
                                                    </span>
                                                )}
                                                {cell === 3 && <span className="text-cyan-200">{t('level8.gridLabels.exit')}</span>}
